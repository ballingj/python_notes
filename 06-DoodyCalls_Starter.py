...
press_release.strip().replace('dog poop', 'pet waste').replace('Doody Calls', 'DoodyCalls')

# Our research shows that it's best to shout our press releases. Make the entire press release uppercased!
press_release.strip().replace('dog poop', 'pet waste').replace('Doody Calls', 'DoodyCalls').upper()
